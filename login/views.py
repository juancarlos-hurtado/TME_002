...
def complete_victim_profile(request):
    ...
    return render (request, 'complete_victim_profile.html', context)
...
def complete_solicitante_profile(request):
    ...
    return render(request, 'complete_solicitante_profile.html', context )
...
def registrar_victima(request):
    return render(request, 'complete_victim_profile.html')
