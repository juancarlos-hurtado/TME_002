...
class create_form(forms.Form):
    ...
    CHOICES = [('Víctima', 'Víctima'), ('Servidor Público', 'Servidor'), ('Solicitante Externo', 'Solicitante')]
    create_user_type = forms.ChoiceField(
        choices = CHOICES, 
        widget = forms.RadioSelect(attrs = {'class': 'radio_group'}))
    ...
    def clean_create_user_type(self):
        create_user_type = self.cleaned_data['create_user_type']
